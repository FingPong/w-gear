...
<header class="header">
    <nav class="grid header__nav">
        <div class="header__brand">  
            <a href="index.php" class="header__logo">W<i class="header__logo-icon fa-solid fa-keyboard"></i>GEAR</a>  
            <span>&copy;</span>
        </div>
            ...
            <div class="header__user--container">
                ...
                <div class="header__user-account">
                    ...
                    <div class="header__user-account-info">
                        ...
                        ?>
                            <div class="sign-out">
                                <h4 class="header__cart-list--heading">ÚI GIỜI !!</h4>
                                <h4 class="header__cart-list--heading">BẠN CHƯA ĐĂNG NHẬP</h4>
                                <button class="btn btn--pri btn-sign-in" id="sign-in-button">HÃY ĐĂNG NHẬP NGAY</button>
                            </div>
                            <script> 
