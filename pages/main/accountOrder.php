...
<script>
    ...
    document.getElementById('orderbutton').classList.remove("fa-cart-shopping");
    document.getElementById('orderbutton').classList.add("fa-arrow-left-long");

    document.getElementById('accountbutton').addEventListener('click', function() {
        location.href = "index.php?taikhoan";
    });
</script>
