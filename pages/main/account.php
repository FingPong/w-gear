...
<div class="grid container__wrapper-products">
    <div id="user-info-form" class="user-info-form" style="margin-bottom:100px">
        <div class="detail-form__product-configuration-heading" style="margin-bottom:20px; margin-top: 40px">
            <h4 id="account-info-header" style="color:#00FF7F">THÔNG TIN TÀI KHOẢN</h4>
        </div>
        <div class="sign-in">  
            <div class="button-order">
                <button onclick="myOrder()" id="accountbutton" class="btn btn--sec order-button"><i style="font-size:30px; line-height:50px" id="orderbutton" class="icon fa-solid fa-cart-shopping"></i></button>
            </div>
                ...
                <div class="user-table" id="user-table"> 
                    <?php
                        if (isset($_GET['donhang'])) {
                            include("pages/main/accountOrder.php");
                        }
                        else {
                    ?>
...
<script>
    ...
    function myOrder() { 
        location.href = `index.php?taikhoan&donhang`;
